(function(){
  ...
  function corniceElemLabel(item){
    if(item.shape==="straight"){
      var off=Math.round(+item.offsetY||0);
      return "Карниз до ванної, прямий "+Math.round(+item.lengthA||0)+" см"+(off>0?" · "+off+" см від стіни":"");
    }
    return "Карниз ванної, Г-подібний "+Math.round(+item.lengthB||0)+"×"+Math.round(+item.lengthA||0)+" см";
  }
