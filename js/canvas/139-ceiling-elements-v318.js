...
window.rmStartDoubleSpotV1=function(){
  ...
  m.innerHTML='<div class="modal rm-double-orient-modal"><div class="rm-ce-head rm-double-orient-head"><div><div class="rm-ce-title">Положення світильника</div></div><button type="button" class="rm-ce-close" onclick="this.closest(\'.modal-overlay\').remove()">×</button></div><div class="rm-double-orient-grid"><button type="button" class="rm-double-orient-btn" aria-label="Горизонтально" title="Горизонтально" onclick="rmUseDoubleSpotV1(\'horizontal\')"><span class="rm-double-icon horizontal"><i></i><i></i></span></button><button type="button" class="rm-double-orient-btn" aria-label="Вертикально" title="Вертикально" onclick="rmUseDoubleSpotV1(\'vertical\')"><span class="rm-double-icon vertical"><i></i><i></i></span></button></div></div>';
