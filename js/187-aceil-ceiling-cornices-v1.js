(function(){
  ...
  function wrapFilmAutoFill(){var previous=window.autoFillNomenclature;if(typeof previous!=="function"||previous.__ceilingFilmFix)return;var wrapped=function(){repairFilmSelection();return previous.apply(this,arguments);};wrapped.__ceilingFilmFix=true;window.autoFillNomenclature=wrapped;try{autoFillNomenclature=wrapped;}catch(e){}}
  ...
  function init(){ensureStyle();ensureModal();wrapDrawing();wrapLauncher();wrapPersistence();wrapFilmAutoFill();repairFilmSelection();bindCanvas();injectLauncher();}
